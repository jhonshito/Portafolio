...
const Proyectos = () => {
    ...
    const [objecto, setObjecto] = useState({
        todos : {
            img : [proOne, proTwo, proThree, proFour],
            name : ['E-commerce', 'Country-Api', 'Todo-list', 'Diseño-de-formulario'],
            colorFondo : ['bg-gradient-to-r from-orange-primary to-piel', 'bg-gradient-to-r from-country to-newCountry', 'bg-gradient-to-r from-colorTodo to-colorNewTodo', 'bg-gradient-to-r from-form to-form'],
            sombraColor : ['shadow-piel', 'shadow-newCountry', 'shadow-colorNewTodo', 'shadow-form'],
            sitio : ['https://e-commerce-jhon.netlify.app', 'https://country-apis-jhon.netlify.app', 'https://todo-app-jhon.netlify.app', 'https://formulario-jhon.netlify.app'],
            repositorio : ['https://github.com/jhonshito/New-ecommer-with-react-and-vite', 'https://github.com/jhonshito/country-api', 'https://github.com/jhonshito/frontEnd-todo-mentor', 'https://github.com/jhonshito/Dise-o-de-formulario'],
            tecnologiaOne : ['React', 'React', 'React', 'javaScript'],
            tecnologiaTwo : ['Taikwind', 'CSS3', 'CSS3', 'CSS3']
        },
        apis : {
            img : [proTwo],
            name : ['Country-Api'],
        ...
        web : {
            ...
            tecnologiaOne : ['React', 'React', 'javaScript'],
            tecnologiaTwo : ['Taikwind', 'CSS3', 'CSS3']
        }
    })

    // console.log(objecto.todos.tecnologiaTwo)
            ...
            <article className='block lg:flex lg:gap-x-16 lg:flex-wrap lg:justify-center'>

                {
                    ...
                    filtro.img.map((item, index) => (
                        ...
                        <div key={index} className={`w-80  lg:w-96 border-2 mx-auto lg:mx-0 h-[12rem] rounded-2xl bg-opacity-100 relative mb-72 mt-10 lg:mb-6 ${filtro.colorFondo[index]}`}>
                        ...
                        <div className='lg:bg-transparent mt-10 lg:mt-0 lg:hover:bg-transparente group w-80 rounded-none lg:w-96 h-[12rem] lg:rounded-2xl static lg:absolute  hover:border-transparente peer top-0 hover:backdrop-opacity-0 shadow-none lg:shadow-2xl hover:animate__animated hover:animate__fadeInUp'>
                            <div className='block lg:hidden group-hover:block animate__animated animate__jackInTheBox mt-16 lg:mt-0'>
                                ...
                                <div className='flex justify-center gap-2 text-lg font-medium animate__animated animate__jackInTheBox mt-4 lg:mt-3'>
                                    <span className='dark:text-white lg:dark:text-dark'>{filtro.tecnologiaOne[index]}</span>
                                    <span className='dark:text-white lg:dark:text-dark'>-</span>
                                    <span className='dark:text-white lg:dark:text-dark'>{filtro.tecnologiaTwo[index]}</span>
                                </div>
