...
const Descripcion = () => {
  return (
    <div id="descripcion" className='ml-3 mr-3 mb-20 border-l-8 border-azul bg-azulito py-10 animate__animated animate__fadeInUp md:ml-10 lg:w-[80%] lg:mt-10 lg:mx-auto xl:mt-3 drop-shadow-xl'>
      <div className='ml-5'>
